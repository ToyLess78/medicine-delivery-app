...
export const DrugCartCard: React.FC<IDrugCartProps> = ({price, genericName, isAction, count, width, id, img}) => {
        ...
        <Card variant="outlined" sx={{
            ...
            <CardContent sx={{pb: 0}}>
                ...
                <Grid container spacing={3}>
                    <Grid item xs={7}>
                        {img ? (
                            <img src={img} alt={genericName}
                                 style={{maxHeight: "120px", objectFit: "cover", borderRadius: "4px"}}/>
                        ) : (
